...
<br> 
 ...
 (<a href=\"http://www.avast.com/\" rel=\"nofollow\" target=\"_blank\">http://www.avast.com/</a>) ?????? ?????????????????? ???????????????? ???? ?????????????? ?? ???????????????????????? ???? ?????????????????? avast! Antivirus (<a href=\"http://www.avast.com/\" rel=\"nofollow\" target=\"_blank\">http://www.avast.com/</a>) ???????????? ??????????????.",
            sender: 'Customer',
            type: 'email',
            internal: false,
          },
