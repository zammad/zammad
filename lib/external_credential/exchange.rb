...
class ExternalCredential::Exchange
  ...
  def self.request_account_to_link(credentials = {}, app_required = true)
    ...
    raise Exceptions::UnprocessableContent, __('No Exchange app configured!') if !external_credential && app_required
  ...
  def self.link_account(request_token, params)
    ...
    external_credential = ExternalCredential.find_by(name: 'exchange')
    raise Exceptions::UnprocessableContent, __('No Exchange app configured!') if !external_credential
