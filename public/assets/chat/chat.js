  ...
  ZammadChat = (function(superClass) {
    ...
    ZammadChat.prototype.translations = {
      ...
      'nl': {
        ...
        'Since you didn\'t respond in the last %s minutes your conversation with <strong>%s</strong> was closed.': 'Omdat je niet hebt gereageerd in de laatste %s minuten is je chat met <strong>%s</strong> afgesloten.',
