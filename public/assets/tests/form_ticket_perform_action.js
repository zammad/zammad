...
test( "ticket_perform_action check", function() {
  ...
  $('form').find('.js-add').last().click()
  $('form').find('.js-attributeSelector .form-control').last().val('notification.email').trigger('change')
  $('form').find('.js-setNotification [name="ticket_perform_action3::notification.email::subject"]').val('some subject').trigger('change')
  $('form').find('.js-setNotification [data-name="ticket_perform_action3::notification.email::body"]').html('some body').trigger('change')
  $('form').find('.js-setNotification .js-recipient .js-option[data-value="ticket_owner"]').click()
