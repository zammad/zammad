...
import CommonAvatar from '@common/components/common/CommonAvatar.vue'
import type { AvatarSize, AvatarUser } from '@common/types/avatar'
import { getInitials } from '@common/utils/formatter'
