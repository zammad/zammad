...
export type Mutations = {
  ...
  /** Translate several articles of a ticket at once, for an agent who switched the whole ticket to a target language */
...
export type TicketArticleTranslateManyPayload = {
  ...
  /** The translations that are available already; the others are delivered by the subscription */
  translations?: Maybe<Array<TicketArticleTranslation>>;
};
...
/** The translation of one article of a ticket */
export type TicketArticleTranslation = {
  __typename?: 'TicketArticleTranslation';
