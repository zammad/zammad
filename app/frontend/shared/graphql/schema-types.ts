...
/** The translation of the content of an object */
export type ContentTranslation = {
  __typename?: 'ContentTranslation';
  /** The service that produced the translation, e.g. "ai" */
  backend?: Maybe<Scalars['String']['output']>;
  /** The translated content, in the format of the original */
  content?: Maybe<Scalars['String']['output']>;
  /** False if the content was returned as it is, because there was nothing to translate */
  translated?: Maybe<Scalars['Boolean']['output']>;
};

/** Autogenerated return type of CtiCallPickup. */
export type CtiCallPickupPayload = {
  __typename?: 'CtiCallPickupPayload';
  /** The view to open, resolved on the server */
  target?: Maybe<CtiPickupTarget>;
};

/** Caller log entry of the CTI integration */
export type CtiLog = {
  __typename?: 'CtiLog';
  ...
  durationTalkingTime?: Maybe<Scalars['Int']['output']>;
  durationWaitingTime?: Maybe<Scalars['Int']['output']>;
  from: Scalars['String']['output'];
  /** Name the telephony backend sent for the calling side, e.g. the agent who dialled */
  fromComment?: Maybe<Scalars['String']['output']>;
  /** Caller IDs matched to the calling number */
  fromMatches: Array<CtiLogCallerIdMatch>;
  fromPretty: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  state: Scalars['String']['output'];
  to: Scalars['String']['output'];
  /** Name the telephony backend sent for the called side, e.g. the agent who answered or the queue */
  toComment?: Maybe<Scalars['String']['output']>;
  /** Caller IDs matched to the called number */
  toMatches: Array<CtiLogCallerIdMatch>;
  toPretty: Scalars['String']['output'];
  /** Last update date/time of the record */
  updatedAt: Scalars['ISO8601DateTime']['output'];
};

/** A caller ID matched to one side of a call, either a known or a possible user */
export type CtiLogCallerIdMatch = {
  __typename?: 'CtiLogCallerIdMatch';
  comment?: Maybe<Scalars['String']['output']>;
  /** Match quality, 'known' or 'maybe' */
  level: Scalars['String']['output'];
  user?: Maybe<User>;
};

/** The connection type for CtiLog. */
export type CtiLogConnection = {
  __typename?: 'CtiLogConnection';
  /** A list of edges. */
  edges: Array<CtiLogEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Indicates the total number of available records. */
  totalCount: Scalars['Int']['output'];
...
/** Autogenerated return type of CtiLogDoneUpdate. */
export type CtiLogDoneUpdatePayload = {
  __typename?: 'CtiLogDoneUpdatePayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** The updated caller log entry */
  log?: Maybe<CtiLog>;
};

/** An edge in a connection. */
export type CtiLogEdge = {
  __typename?: 'CtiLogEdge';
...
/** Autogenerated return type of CtiLogUpdates. */
export type CtiLogUpdatesPayload = {
  __typename?: 'CtiLogUpdatesPayload';
  /** A new call needs to be added to the caller log */
  addLog?: Maybe<CtiLog>;
  /** A call must be removed from the caller log */
  removeLogId?: Maybe<Scalars['ID']['output']>;
  /** An existing call was changed */
  updateLog?: Maybe<CtiLog>;
};

/** The view an agent who picked up a call lands on, decided on the server like for the old UI */
export type CtiPickupTarget = {
  __typename?: 'CtiPickupTarget';
  /** Detected customer, when any */
  customer?: Maybe<User>;
  /** The picked-up call */
  log: CtiLog;
  view: EnumCtiPickupView;
};

/** What the navigation entry of the CTI integration shows for the current user */
export type CtiSidebar = {
  __typename?: 'CtiSidebar';
  /** Calls still ringing among the entries the caller log shows, newest first */
  ringingCalls: Array<CtiLog>;
  /** Calls not marked as done, across the whole caller log of the user */
  unhandledCount: Scalars['Int']['output'];
};

/** Autogenerated return type of CtiSidebarUpdates. */
export type CtiSidebarUpdatesPayload = {
  __typename?: 'CtiSidebarUpdatesPayload';
  /** The current state, resolved like the ctiSidebar query */
  sidebar?: Maybe<CtiSidebar>;
};
...
/** View to open for an agent who picked up a call */
export enum EnumCtiPickupView {
  /** The ticket create screen, for the detected customer or the calling number */
  TicketCreate = 'ticketCreate',
  /** The detail view of the detected customer */
...
export type KnowledgeBase = {
  ...
  /** How the top level categories of the knowledge base are ordered when browsed */
...
/** Autogenerated return type of KnowledgeBaseAnswerDelete. */
export type KnowledgeBaseAnswerDeletePayload = {
  __typename?: 'KnowledgeBaseAnswerDeletePayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** Was the mutation successful? */
  success?: Maybe<Scalars['Boolean']['output']>;
...
export type KnowledgeBaseCategory = {
  ...
  /** How the subcategories of this category are ordered when browsed */
  categorySortingMode: EnumKnowledgeBaseSortingMode;
  /** Create date/time of the record */
  createdAt: Scalars['ISO8601DateTime']['output'];
...
/** Autogenerated return type of KnowledgeBaseReorderAnswers. */
export type KnowledgeBaseReorderAnswersPayload = {
  __typename?: 'KnowledgeBaseReorderAnswersPayload';
  /** The category with its updated `answerSortingMode`. */
  category?: Maybe<KnowledgeBaseCategory>;
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
};

/** Autogenerated return type of KnowledgeBaseReorderCategories. */
export type KnowledgeBaseReorderCategoriesPayload = {
  __typename?: 'KnowledgeBaseReorderCategoriesPayload';
  /** The category with its updated `categorySortingMode`. */
  category?: Maybe<KnowledgeBaseCategory>;
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
};

/** Autogenerated return type of KnowledgeBaseReorderRootCategories. */
export type KnowledgeBaseReorderRootCategoriesPayload = {
  __typename?: 'KnowledgeBaseReorderRootCategoriesPayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** The knowledge base with its updated `categorySortingMode`. */
  knowledgeBase?: Maybe<KnowledgeBase>;
};
...
export type Mutations = {
  ...
  /** Mark a caller log entry of the CTI integration as handled or as not handled */
  ctiLogDoneUpdate?: Maybe<CtiLogDoneUpdatePayload>;
  ...
  knowledgeBaseAnswerDelete?: Maybe<KnowledgeBaseAnswerDeletePayload>;
  ...
  /** Set how the answers of a knowledge base category are ordered, and store their hand-made order. The subcategories of that category are a list of their own, unaffected by this (see KnowledgeBaseReorderCategories). */
  knowledgeBaseReorderAnswers?: Maybe<KnowledgeBaseReorderAnswersPayload>;
  /** Set how the subcategories of a knowledge base category are ordered, and store their hand-made order. The answers of that category are a list of their own, unaffected by this (see KnowledgeBaseReorderAnswers). */
  knowledgeBaseReorderCategories?: Maybe<KnowledgeBaseReorderCategoriesPayload>;
  /** Set how the top level categories of the knowledge base are ordered, and store their hand-made order. */
  knowledgeBaseReorderRootCategories?: Maybe<KnowledgeBaseReorderRootCategoriesPayload>;
  ...
  /** Return a stored translation of an article or trigger its generation in the background */
  ticketArticleTranslate?: Maybe<TicketArticleTranslatePayload>;
  /** Check or generate translations for several articles of a ticket */
  ticketArticleTranslateMany?: Maybe<TicketArticleTranslateManyPayload>;
  ...
  /** Update the caller notification setting of the current user */
  userCurrentCallerNotificationUpdate?: Maybe<UserCurrentCallerNotificationUpdatePayload>;
  /** Change user password. */
  userCurrentChangePassword?: Maybe<UserCurrentChangePasswordPayload>;
  /** Remember whether the current user reads whole tickets in their target language */
  userCurrentContentTranslationAuto?: Maybe<UserCurrentContentTranslationAutoPayload>;
  /** Remember the language the current user translates content into */
  userCurrentContentTranslationTargetLocale?: Maybe<UserCurrentContentTranslationTargetLocalePayload>;
...
/** All available mutations */
export type MutationsCtiLogDoneUpdateArgs = {
...
/** All available mutations */
export type MutationsKnowledgeBaseAnswerDeleteArgs = {
...
/** All available mutations */
export type MutationsKnowledgeBaseReorderAnswersArgs = {
...
/** All available mutations */
export type MutationsKnowledgeBaseReorderCategoriesArgs = {
...
/** All available mutations */
export type MutationsKnowledgeBaseReorderRootCategoriesArgs = {
  categoryIds?: InputMaybe<Array<Scalars['ID']['input']>>;
  sortingMode: EnumKnowledgeBaseSortingMode;
};
...
/** All available mutations */
export type MutationsTicketArticleTranslateManyArgs = {
  afterCursor?: InputMaybe<Scalars['String']['input']>;
  beforeCursor?: InputMaybe<Scalars['String']['input']>;
  firstArticlesCount?: InputMaybe<Scalars['Int']['input']>;
  generateMissing?: InputMaybe<Scalars['Boolean']['input']>;
...
/** All available mutations */
export type MutationsUserCurrentCallerNotificationUpdateArgs = {
...
/** All available mutations */
export type MutationsUserCurrentContentTranslationAutoArgs = {
  enabled: Scalars['Boolean']['input'];
};


/** All available mutations */
export type MutationsUserCurrentContentTranslationTargetLocaleArgs = {
  targetLocale: Scalars['String']['input'];
};
...
export type PolicyKnowledgeBaseCategory = {
  ...
  /** Is the user allowed to delete this object? */
  destroy: Scalars['Boolean']['output'];
  /** Is the user allowed to delete answers in this category? */
  destroyAnswer: Scalars['Boolean']['output'];
...
export type Queries = {
  ...
  /** Fetch the paginated caller log of the CTI integration, newest first */
  ctiLogs: CtiLogConnection;
  /** Fetch the counter and the ringing calls the navigation entry of the CTI integration shows */
  ctiSidebar: CtiSidebar;
  ...
  /** Locales a ticket article can be translated into with the configured translation service */
  ticketArticleTranslationTargetLocales: Array<Locale>;
...
/** All available queries */
export type QueriesCtiLogsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type QueriesKnowledgeBaseAnswersArgs = {
  ...
  last?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  sortingMode?: InputMaybe<EnumKnowledgeBaseSortingMode>;
};
...
export type Subscriptions = {
  ...
  /** The view to open when the current user picks up a call of the CTI integration */
  ctiCallPickup: CtiCallPickupPayload;
  /** Changes to the caller log of the CTI integration */
  ctiLogUpdates: CtiLogUpdatesPayload;
  /** Updates to what the navigation entry of the CTI integration shows for the current user */
  ctiSidebarUpdates: CtiSidebarUpdatesPayload;
  ...
  /** Updates to triggered translations of the articles of a ticket */
  ticketArticleTranslationUpdates: TicketArticleTranslationUpdatesPayload;
...
/** All available subscriptions */
export type SubscriptionsTicketArticleTranslationUpdatesArgs = {
  targetLocale: Scalars['String']['input'];
  ticketId: Scalars['ID']['input'];
};
...
export type TicketArticle = {
  ...
  /** The stored translation of the current article content */
  translation?: Maybe<ContentTranslation>;
  /** Whether a translation into the given locale is stored for the current content of this article */
...
/** Ticket articles */
export type TicketArticleTranslationArgs = {
  targetLocale: Scalars['String']['input'];
};


/** Ticket articles */
export type TicketArticleTranslationAvailableArgs = {
...
/** Autogenerated return type of TicketArticleTranslateMany. */
export type TicketArticleTranslateManyPayload = {
...
/** Autogenerated return type of TicketArticleTranslate. */
export type TicketArticleTranslatePayload = {
  __typename?: 'TicketArticleTranslatePayload';
  /** Analytics metadata */
  analytics?: Maybe<AiAnalyticsMetadata>;
  /** The article whose translation was requested */
...
/** Autogenerated return type of TicketArticleTranslationUpdates. */
export type TicketArticleTranslationUpdatesPayload = {
...
export type User = ObjectAttributeValuesInterface & {
  ...
  /** Whether the user may have the articles of a whole ticket translated automatically */
  hasContentTranslationAutoAvailable?: Maybe<Scalars['Boolean']['output']>;
...
/** Autogenerated return type of UserCurrentCallerNotificationUpdate. */
export type UserCurrentCallerNotificationUpdatePayload = {
  __typename?: 'UserCurrentCallerNotificationUpdatePayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** Whether the caller notification setting was updated successfully */
  success: Scalars['Boolean']['output'];
};
...
/** Autogenerated return type of UserCurrentContentTranslationAuto. */
export type UserCurrentContentTranslationAutoPayload = {
  __typename?: 'UserCurrentContentTranslationAutoPayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
...
/** Autogenerated return type of UserCurrentContentTranslationTargetLocale. */
export type UserCurrentContentTranslationTargetLocalePayload = {
  __typename?: 'UserCurrentContentTranslationTargetLocalePayload';
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** Was the update successful? */
  success: Scalars['Boolean']['output'];
...
export type UserPersonalSettings = {
  ...
  /** Whether the caller notification for incoming calls is enabled */
  callerNotificationEnabled: Scalars['Boolean']['output'];
