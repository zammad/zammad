...
export type Group = {
  ...
  followUpAssignment?: Maybe<Scalars['Boolean']>;
  followUpPossible?: Maybe<Scalars['String']>;
  id: Scalars['ID'];
  name?: Maybe<Scalars['String']>;
  /** Internal note */
...
export type TwoFactorMethodInitiateAuthenticationPayload = {
  ...
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  initiationData?: Maybe<Scalars['JSON']>;
};
...
export type UserTwoFactorMethods = {
  ...
  recoveryCodesAvailable: Scalars['Boolean'];
};
