...
<template>
  <header
    class="grid w-full grid-cols-[1fr_min-content] grid-rows-[1.5rem_auto] gap-x-2 gap-y-2.5 border-b border-neutral-100 bg-neutral-50/80 px-5.5 py-3 backdrop-blur-2xs dark:border-gray-900 dark:bg-gray-500/80"
  >
    <CommonBreadcrumb
      class="flex"
      :items="breadcrumbs"
    ...
    <!-- c -->
    <CommonLabel
      class="col-span-2 mx-auto w-full max-w-[calc(var(--container-7xl)-2.750rem)] text-xl font-medium text-black dark:text-white"
      tag="span"
    >
      {{ title }}
    </CommonLabel>
