...
export default function useEditorActions(
  ...
  const getActionsList = (): EditorButton[] => [
    ...
    },
    {
      ...
      icon: 'editor-text-color',
      command: focused((c) => c.toggleHighlight()),
    },
    {
      id: getUuid(),
      name: 'textAlign',
      ...
      subMenu: [
        {
          ...
          command: focused((c) => c.setTextAlign('left')),
        },
        {
          id: getUuid(),
          name: 'textAlign',
          ...
          command: focused((c) => c.setTextAlign('center')),
        },
        {
          id: getUuid(),
          name: 'textAlign',
          ...
          icon: 'editor-indent-right',
          attributes: { textAlign: 'right' },
          command: focused((c) => c.setTextAlign('right')),
        },
        {
          id: getUuid(),
          name: 'textAlign',
          ...
          command: focused((c) => c.setTextAlign('justify')),
        },
      ],
    },
    {
