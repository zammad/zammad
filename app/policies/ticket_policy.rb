...
class TicketPolicy < ApplicationPolicy
  ...
  def customer_field_scope
    @customer_field_scope ||= ApplicationPolicy::FieldScope.new(deny: %i[ai_agent_running ai_summary_enabled time_unit time_units_per_type accounted_time_type checklist referencing_checklist_tickets ai_stored_results])
  end
end
