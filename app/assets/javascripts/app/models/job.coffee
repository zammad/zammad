class App.Job extends App.Model
  ...
  @configure_attributes = [
    ...
    { name: 'condition',            display: __('Conditions for affected objects'), tag: 'object_selector', null: false, executionTime: true, noCurrentUser: true, hasTaskbarEntries: true },
    { name: 'perform',              display: __('Execute changes on objects'),      tag: 'object_perform_action', null: true, notification: true, ticket_delete: true, data_privacy_deletion_task: true, close_taskbars: true, ai_agent: true, placeholder_current_user: false },
