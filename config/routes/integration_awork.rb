Zammad::Application.routes.draw do
  ...
  match api_path + '/integration/awork/tasks',                    to: 'integration/awork#update',                 via: :post
  ...
  match api_path + '/integration/awork/projects/:id/tasks',       to: 'integration/awork#tasks_by_project',       via: :get
