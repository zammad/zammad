# Change Log for Zammad 7.0.2

- [Release notes](https://zammad.com/en/releases/7-0-2)
...
- [Full commit log](https://github.com/zammad/zammad/compare/7.0.1...7.0.2)
- [File tree](https://github.com/zammad/zammad/tree/7.0.2)
