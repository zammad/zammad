...
Translation.create_if_not_exists( :locale => 'de', :source => "Select the customer of the Ticket or create one.", :target => "Wähle den Kundenf�r das Ticket oder erstell einen neuen.", :updated_by_id => 1, :created_by_id => 1  )
