...
Setting.create_if_not_exists(
  ...
  preferences: {
    controller: 'SettingsAreaSwitch',
    sub: ['auth_auth0_credentials'],
    title_i18n: ['Auth0'],
    description_i18n: ['Auth0', 'Auth0 Console', 'https://manage.auth0.com/#/'],
    permission: ['admin.security'],
  },
  state: false,
  frontend: true
...
Setting.create_if_not_exists(
  title: 'Auth0 App Credentials',
  name: 'auth_auth0_credentials',
  area: 'Security::ThirdPartyAuthentication::Auth0',
  ...
  options: {
    form: [
      ...
      { 
        ...
        name: 'site',
        tag: 'input',
        placeholder: 'https://YOURDOMAIN.auth0.com',
      },
    ],
  },
  state: {},
